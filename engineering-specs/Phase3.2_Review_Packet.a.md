...
- **Important context:** all design + code here was authored by the same party, self-reviewed for internal correctness and wrote the test harness, but
...
5. **Test is author-written** The 11 passing checks prove
